...
const bugdrop = new BugDrop({ secretKey: process.env.BUGDROP_SECRET_KEY });
...
The raw subject is transformed locally into an Application-scoped HMAC pseudonym. The request body
